...
<div style="display: flex; flex-direction: row; align-items: center; height:400;">
    <img src="./src/assets/Frame%2015.png" width:100%; />
    <img src="./src/assets/mobile.png" width:100%; />
</div>
