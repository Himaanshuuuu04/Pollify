...
export default function Home() {
  return (
    <div>
      {/* Title Section */}
      <div className="text-4xl md:text-6xl text-white font-bold text-center my-10 md:my-6 mx-3">
        Shape the Future with Your Vote!
        <div className="text-xl md:text-3xl font-bold my-3 md:my-6">
      ...
      <div className="text-white text-center mx-4 my-[5rem] mb-0" >
      <h2 className="text-[1.75rem] font-bold ">The ballot is stronger than the bullet.</h2>
      <p className="text-xl">Abraham Lincoln</p>
      </div>
      <Button />
    </div>
  );
